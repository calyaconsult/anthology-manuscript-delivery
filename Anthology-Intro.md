...
That a chatbot/LLM can write sonnets in the style of John Donne but cannot properly answer the question "how many 'r' are in 'terrestrian?' will surprise many users but it shouldnt. Statistically, the numbers 2, 3, and 4 are so close together in this context that the LLM might choose any of them.
